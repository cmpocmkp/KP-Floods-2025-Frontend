...
// Enhanced sample report data for KPD3
const sampleReportData = {
      title: "KPD3 IMPACT ASSESSMENT",
...
app.get('/health', (req, res) => {
  res.json({
    ...
    timestamp: new Date().toISOString(),
            message: 'KPD3 Reports Server is running'
  });
});
...
app.listen(PORT, () => {
  console.log(`KPD3 Reports Server running on port ${PORT}`);
