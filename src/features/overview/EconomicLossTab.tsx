...
export function EconomicLossTab() {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Direct infrastructure and asset damage
            </p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Sector-wise Economic Losses</CardTitle>
          <p className="text-sm text-muted-foreground">
            Detailed breakdown of losses across all economic sectors with percentages
          </p>
        </CardHeader>
        <CardContent>
